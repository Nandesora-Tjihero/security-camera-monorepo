...
<template>
  <Page class="" @loaded="onPageLoaded" actionBarHidden="true">
    <GridLayout class="py-40" rows="300 * 56 120">
      <Image
        paddingTop="300"
      ...
      >
        <FormattedString>
          ...
          />
          <Span text="al instante." color="#2b6cee" />
        </FormattedString>
      </Label>
...
.blue-glow-bg-dark {
  ...
  background-image: linear-gradient(to right, #101622, #101622cc, transparent);
